...
const Contadores = (props) => {
  ...
  useEffect(() => {
    if (prevCount1 !== count1) {
      setHistory([
        `Contador 1: ${count1} Valor Anterior ${prevCount1}, Contador 2: Sin cambios  , Contador 3: Sin cambios`,
      ]);
  ...
  useEffect(() => {
    if (prevCount2 !== count2) {
      setHistory([
        `Contador 1: Sin cambios, Contador 2: ${count2} Valor Anterior: ${prevCount2}, Contador 3: Sin cambios`,
      ]);
      setLastChange(new Date());
    }
  }, [count2]);
  ...
  useEffect(() => {
    if (prevCount3 !== count3) {
      setHistory([
        `Contador 1: Sin cambios, Contador 2:Sin cambios ,Contador 3: ${count3} Valor Anterior: ${prevCount3}`,
      ]);
      setLastChange(new Date());
    }
  }, [count3]);
